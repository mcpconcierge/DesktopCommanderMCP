...
⚠️⚠️⚠️ First, ensure you've downloaded and installed: 
  a. [Claude Desktop app](https://claude.ai/download) and 
  b. You have [npm installed](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm).
  c. You have [Git](https://git-scm.com/downloads) 
